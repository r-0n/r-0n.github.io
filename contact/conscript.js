(function() {
    ...
    MESSAGES.push({
        delay: 0,
        text: "A day is made by people who care...",
    });

    MESSAGES.push({
        delay: 1200,
        text: "People we can truly call friends..."
    });

    MESSAGES.push({
        delay: 2200,
        text: "A day is made by people who love..."
    });

    MESSAGES.push({
        delay: 3600,
        text: "People with whom we truly share a bond..."
    });

    MESSAGES.push({
        delay: 5200,
        text: "A day is perfect when you always have a family"
    });

    MESSAGES.push({
        delay: 5200,
        text: "To help you in any way and share in all your laughter"
    });
    MESSAGES.push({
        delay: 5200,
        text: "Scroll down to see a heartfelt video about friendship"
    });
...
function rotateInSlide() {
    slides[slideIndex].style.transform = 'none';
}

function rotateOutSlide() {
    slides[slideIndex].style.transform = 'rotateY(90deg) translateZ(-300px)';
}
